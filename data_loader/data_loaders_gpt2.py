...
from utils import *
from .preprocess_script_gpt2 import empty_sub, preprocess_text, merge_text_data
...
#   
    ...
    def get_processed_video_path(self, image_path):
        # For Vip
#        return Path(image_path + '/cache_v3/' + 'processed_video_vip_open.pickle')
        # For Open-ened
        return {m: Path(image_path) / 'cache_v3' / ('processed_video_' + m + '_open_ended.pickle') for m in modes}
